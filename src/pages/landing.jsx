    ...
    <div className='flex flex-col items-center'>
      ...
      <Accordion type="multiple" collapsible className='w-full md:px-11' >
        <AccordionItem value="item-1">
          <AccordionTrigger>How does the Dotzy URL Shortner works?</AccordionTrigger>
          <AccordionContent>
        ...
        <AccordionItem value="item-2">
          ...
          <AccordionContent>
            Yes. Creating an account allows you to manage your URLs, views analytics and customize your short URL.
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="item-3">
          ...
          <AccordionContent>
            You can view the number of clicks, geolocation data of the clicks and devices type (mobile/desktop) for each of your shortened URLs.
          </AccordionContent>
        </AccordionItem>
      </Accordion>
    </div>
