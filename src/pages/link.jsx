    ...
    <>
      ...
      <div className="flex flex-col gap-8 sm:flex-row justify-between">
        <div className="flex flex-col items-start gap-8 rounded-lg sm:w-2/5 ml-5">
          ...
          <a  href={`dotzy.vercel.app/${link}`} target="_blank"
          className="text-3xl sm:text-4xl text-blue-400 font-bold hover:underline cursor-pointer">
            dotzy.vercel.app/{link}
          </a>
          
          <a  href={url?.original_url} target="_blank"
            className="flex items-center gap-1 hover:inderline cursor-pointer">
          ...
          <div className='flex gap-2'>
            <Button variant="ghost" onClick={() =>
              navigator.clipboard.writeText(`https://dotzy.vercel.app/${url?.short_url}`)
            }>
              <Copy />
            </Button>
          ...
          <img 
            src={url?.qr}
            className="h-100 w-100 self-center sm:self-start ring ring-blue-500 p-1 object-contain"
            alt="qr code"
          />
        </div>
